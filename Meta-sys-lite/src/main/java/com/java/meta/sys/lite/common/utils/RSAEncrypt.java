...
public class RSAEncrypt {
    ...
    public static Map<Integer, String> genKeyPair() {
        Map<Integer, String> keyMap = new HashMap<>(3);
     ...
     * @return 密文
     */
    public static String encryptData(@NotNull String str, String publicKey) {
        //base64编码的公钥
     ...
     * @return 铭文
     */
    public static String decryptData(String str, String privateKey) {
        //64位解码加密后的字符串
